...
// Sat Apr  5 13:23:02 2025 by ROOT version 6.34.04
...
public :
   ...
   TH1F* h_pileup;  // Declare the histogram for pileup


   DYSelector(TTree * /*tree*/ =0) { }
   ~DYSelector() override { }
   ...
   ClassDefOverride(DYSelector,0);

};

#endif

#ifdef DYSelector_cxx
void DYSelector::Init(TTree *tree)
{
